...
const GridModel = () => {
    const categories = [
        {
            title: "Challenges",
            items: [
                { name: "Algorithms", icon: <Code className="w-4 h-4" />, href: "/challenges/algorithms" },
                { name: "Data Structures", icon: <Terminal className="w-4 h-4" />, href: "/challenges/data-structures" },
    ...
    return (
        <div className="absolute top-16 right-8 bg-gray-900 border border-gray-700 shadow-xl rounded-lg w-[480px] z-50">
            <div className="p-4">
                        ...
                        <div key={index} className="space-y-3">
                            ...
                            <div className="space-y-1">
                                {category.items.map((item, idx) => (
                                    ...
                                    >
                                        <span className="text-gray-500 group-hover:text-orange-500 transition-colors">
                                            {item.icon}
                                        </span>
